...
import Discord, { ButtonStyle, CommandInteractionOptionResolver } from "discord.js";
...
export default class UpdateIRIS extends IRISSubcommand {
  ...
  static parentCommand = "Admin"
    ...
    public setup(parentCommand: any, client: Discord.Client<boolean>): Promise<boolean> {
